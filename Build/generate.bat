...
typedoc --theme WebClientTypedocTheme  --name "Docsvision 5 Web-client 5.5.13. JavaScript API"  --readme ..\README.md --includeDeclarations --excludePrivate --mode modules --excludeExternals --ignoreCompilerErrors --out ../docs TypeScriptDefinitions/
